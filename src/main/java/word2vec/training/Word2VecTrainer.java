...
import word2vec.huffman.HuffmanCoding;
import word2vec.model.Word2VecModel;
import word2vec.neuralnetwork.NeuralNetworkConfig;
import word2vec.neuralnetwork.NeuralNetworkTrainer;
import word2vec.util.AC;
import word2vec.util.ProfilingTimer;
