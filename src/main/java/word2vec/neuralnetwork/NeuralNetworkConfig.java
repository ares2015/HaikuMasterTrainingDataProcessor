...
public class NeuralNetworkConfig {
	...
	public NeuralNetworkTrainer createTrainer(ImmutableMultiset<String> vocab, Map<String, HuffmanNode> huffmanNodes, Word2VecTrainerBuilder.TrainingProgressListener listener) {
