...
class CBOWModelTrainer extends NeuralNetworkTrainer {
	...
	CBOWModelTrainer(NeuralNetworkConfig config, Multiset<String> counts, Map<String, HuffmanNode> huffmanNodes, Word2VecTrainerBuilder.TrainingProgressListener listener) {
